...
@app.post("/PostAhuTotalPowerDaily")
async def PostAhuTotalPowerDaily(startDate: str, endDate: str):
    result = await BemsService.PostAhuTotalPowerDaily(startDate, endDate)
...
@app.post("/PostAhuTotalPowerHourly")
async def PostAhuTotalPowerHourly(runDate: str):
    result = await BemsService.PostAhuTotalPowerHourly(runDate)
    return JSONResponse(result)
